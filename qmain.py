...
if __name__ == '__main__':
    ...
    parser.add_argument('--layer', type=int, default=None, help='number of repeated variational quantum layer')
    ...
    if config.layer is None:
        config.layer = int(np.ceil(np.log2(config.qubits)))
        
    print(config)
    
    #Pennylane DOE_ansatz
    ...
    # construct generator circuit for both atom vector and node matrix
        ...
        qml.BasicEntanglerLayers(weights=w, wires=range(config.qubits), rotation=qml.RY)
